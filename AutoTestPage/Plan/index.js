...
export default class Add extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      notifier_secret: props.planMsg.notifier && props.planMsg.notifier.secret
    };
  }
  ...
  handleSubmit = async () => {
    ...
    let params = {
      ...
      notifier_secret: this.state.notifier_secret
    };
      ...
      <div className="m-panel">
        <Form>
          ...
          <div>
            ...
            <FormItem {...formItemLayout} label={<span>钉钉机器人URL&nbsp;<a rel="noopener noreferrer" target="_blank" href="https://github.com/congqiu/yapi-plugin-auto-test/blob/master/README.md#%E6%B5%8B%E8%AF%95%E8%AE%A1%E5%88%92">文档</a></span>}>
              {getFieldDecorator("notifier_url", {
                initialValue: this.state.notifier_url
              })(<Input placeholder="钉钉机器人webhook的地址" />)}
            </FormItem>
            <FormItem {...formItemLayout} label={<span>钉钉机器人签名秘钥&nbsp;<a rel="noopener noreferrer" target="_blank" href="https://github.com/congqiu/yapi-plugin-auto-test/blob/master/README.md#%E6%B5%8B%E8%AF%95%E8%AE%A1%E5%88%92">文档</a></span>}>
              {getFieldDecorator("notifier_secret", {
                initialValue: this.state.notifier_secret
              })(<Input placeholder="钉钉机器人签名秘钥" />)}
            </FormItem>
          </div>
